...
const Kelompok = () => {
  ...
  const fetchGenerus = async () => {
    ...
    try {
      ...
      // console.log("Formatted Data:", formattedData); // Log data yang diformat
    ...
    if (
      ...
      const merged = generusData.map((generus) => {
        ...
        return {
          ...
          jenjang: mapJenjang(generus.jenjang),
        };
      });
  ...
  const handleDelete = async (id) => {
    try {
      ...
      setGenerusData((prevData) => prevData.filter((item) => item.id !== id));
      setMergedData((prevData) => prevData.filter((item) => item.id !== id));
    } catch (error) {
  ...
  const handleBulkDelete = async () => {
    try {
      ...
      // Perbarui state lokal untuk menghapus semua item yang dihapus
      setGenerusData((prevData) =>
    ...
    <>
      ...
      <div className="main d-flex">
        <div className={`sidebarWrapper ${sidebarOpen ? "open" : "closed"}`}>
          <Sidebar username={usernames} avatar={avatar} id_desa={id_desa} />
        </div>
